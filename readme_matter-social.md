...
MatterSocial es un web component para compartir contenidos en redes. Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
...
1. Importar el compilado del web-component en el proyecto actual:
    ```bash
    import from '@matter/matter-social/dist/matter-social'
    ```
2. Una vez importado, llamar a dicho web-component a partir de su etiqueta propia individual. Esta llamada se debe realizar desde el fichero .html donde se quiera mostrar el web-component:
    ...
    networks='[
      ...
      {"url": "https://www.instagram.com/andaluciajunta", "name": "instagram", "icon": "fab fa-instagram"},
      {"url": "https://www.linkedin.com/company/junta-de-andalucia/", "name": "linkedin", "icon": "fab fa-linkedin-in"},
      {"url": "https://www.linkedin.com/company/junta-de-andalucia/", "name": "facebook", "icon": "fab fa-facebook-f"}
    ]'>
  </matter-social>
    ```
...
| :----------------- | :-----: | :--------------------------------------------------------------------------------------------------- |
| `networks`         | `Array` | Lista de redes sociales. Cada objeto del array debe incluir `url`, `name` e `icon`.                 |
